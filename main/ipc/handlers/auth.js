...
var authHandlers = {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        console.log("[AuthHandler] Login request for: ".concat(username));
                        return [4 /*yield*/, auth_js_1.default.login(username, password)];
                    case 1:
                        result = _a.sent();
                        if (result.success) {
    ...
    register: function (event, credentials) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        console.log("[AuthHandler] Register request for: ".concat(username));
                        return [4 /*yield*/, auth_js_1.default.register(username, password, email)];
                    case 1:
                        result = _a.sent();
                        if (result.success) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, auth_js_1.default.logout()];
                    case 1:
                        result = _a.sent();
                        if (result.success) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, auth_js_1.default.checkAuth()];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result];
                }
