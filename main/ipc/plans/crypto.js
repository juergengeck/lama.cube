...
function getHandler() {
    if (!cryptoHandler) {
        cryptoHandler = new CryptoHandler_js_1.CryptoHandler(node_one_core_js_1.default);
    }
...
function getKeys(event) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getHandler().getKeys({})];
 ...
 */
function getCertificates(event) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getHandler().getCertificates({})];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    });
 ...
 */
function exportCryptoObject(event, request) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getHandler().exportCryptoObject(request)];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    });
