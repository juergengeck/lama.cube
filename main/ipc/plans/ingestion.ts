/**
 * IPC handlers for document ingestion
 *
...
import { IngestionPlan, type IngestionParams } from '@memory/core';
...
export default function registerIngestionHandlers(ipcMain: any) {
  /**
  ...
  console.log('[IPC] ✅ Ingestion handlers registered');
}
