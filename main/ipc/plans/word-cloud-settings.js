...
var wordCloudSettingsHandler = null;
/**
 * Get handler instance (creates on first use)
 */
function getHandler(nodeOneCore) {
    if (!wordCloudSettingsHandler) {
        wordCloudSettingsHandler = new WordCloudSettingsHandler_js_1.WordCloudSettingsHandler(nodeOneCore, word_cloud_settings_manager_js_1.wordCloudSettingsManager, DEFAULT_SETTINGS);
    }
 ...
 */
function getWordCloudSettings(nodeOneCore) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getHandler(nodeOneCore).getWordCloudSettings({})];
 ...
 */
function updateWordCloudSettings(nodeOneCore, updates) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getHandler(nodeOneCore).updateWordCloudSettings({ updates: updates })];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    });
 ...
 */
function resetWordCloudSettings(nodeOneCore) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getHandler(nodeOneCore).resetWordCloudSettings({})];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    });
