...
class MessageReplication {
  ...
  async initialize(): Promise<any> {
    ...
    try {
      ...
      this.channelManager = new ChannelManager((nodeOneCore as any).multiUser) // Legacy: multiUser not on NodeOneCore interface
  ...
  async handleIncomingMessage(data: any): Promise<any> {
    ...
    (nodeOneCore as any).broadcastUpdate('message', { // Legacy: broadcastUpdate not on NodeOneCore interface
      topicId,
      message
    })
  }
