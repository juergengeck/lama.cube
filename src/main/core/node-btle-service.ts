 ...
 *
 * Wraps @refinio/connection.btle node adapter to provide:
...
import type { BLEPlatformAdapter, DiscoveredBLEDevice } from '@refinio/connection.btle';
import type { BTLEDiscoveryService, BTLEDevice, BTLEScanOptions } from '@refinio/connection.core';
import type { BTLEBroadcastService } from '@refinio/connection.core';
...
class NodeBTLEService implements BTLEDiscoveryService, BTLEBroadcastService {
  ...
  async initialize(): Promise<boolean> {
    ...
    try {
      ...
      const { createNodeAdapter } = await import('@refinio/connection.btle/adapters/node');
