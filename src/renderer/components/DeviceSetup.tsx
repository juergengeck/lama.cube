...
import { Card, CardHeader, CardTitle, CardContent, CardFooter } from '@refinio/lama.ui/components/ui/card'
...
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@refinio/lama.ui/components/ui/select'
import { Badge } from '@refinio/lama.ui/components/ui/badge'
import { Alert, AlertDescription } from '@refinio/lama.ui/components/ui/alert'
import {
  Dialog,
  DialogContent,
  DialogDescription,
  ...
  DialogTitle,
  DialogTrigger,
} from '@refinio/lama.ui/components/ui/dialog'
import {
  QrCode,
  Smartphone,
  Laptop,
