...
export const AIConfigPanel: React.FC<AIConfigPanelProps> = ({ onNavigate }) => {
  ...
  // Callback when servers are changed - reload models
  const handleServersChanged = () => {
    console.log('[AIConfigPanel] Servers changed, reloading models...');
    void loadModels();
  };

  // Callback when models are discovered from servers
  const handleModelsDiscovered = () => {
    console.log('[AIConfigPanel] Models discovered, reloading...');
    void loadModels();
  };
