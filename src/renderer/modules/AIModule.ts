...
import type TopicGroupManager from '@refinio/chat.core/models/TopicGroupManager.js';
...
import { AIPlan } from '@refinio/lama.core/plans/AIPlan';
import { AIAssistantPlan } from '@refinio/lama.core/plans/AIAssistantPlan';
import { TopicAnalysisPlan } from '@refinio/lama.core/plans/TopicAnalysisPlan';
import { ProposalsPlan } from '@refinio/lama.core/plans/ProposalsPlan';
import { KeywordDetailPlan } from '@refinio/lama.core/plans/KeywordDetailPlan';
import { WordCloudSettingsPlan } from '@refinio/lama.core/plans/WordCloudSettingsPlan';
import { LLMConfigPlan } from '@refinio/lama.core/plans/LLMConfigPlan';
import { CryptoPlan } from '@refinio/lama.core/plans/CryptoPlan';
import { AuditPlan } from '@refinio/lama.core/plans/AuditPlan';
import { SubjectsPlan } from '@refinio/lama.core/plans/SubjectsPlan';

// LAMA core AI models (message listener)
import { AIMessageListener } from '@refinio/lama.core/models/ai';

// LAMA core models (LLM and AI object management)
import { LLMObjectManager } from '@refinio/lama.core/models/LLMObjectManager';
import { AIObjectManager } from '@refinio/lama.core/models/AIObjectManager';
import { AISettingsManager } from '@refinio/lama.core/models/settings/AISettingsManager';

// Proposal services
import { ProposalEngine } from '@refinio/lama.core/services/proposal-engine';
import { ProposalRanker } from '@refinio/lama.core/services/proposal-ranker';
import { ProposalCache } from '@refinio/lama.core/services/proposal-cache';
...
import { LLMManager } from '@refinio/lama.core/services/llm-manager';
